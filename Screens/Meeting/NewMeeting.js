...
import { View, Dimensions, Text, Image, KeyboardAvoidingView, ScrollView, TouchableOpacity, Platform, SafeAreaView, StyleSheet } from 'react-native';
...
class NewMeeting extends React.Component {
    ...
    render() {
        const { today, currentTime, futureDate, screenHeight, screenWidth } = this.state
        return (
