            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: chatBackground }}>
                <Header style={{ backgroundColor: chatBackground, borderBottomWidth: 0 }}>
                    <Body style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontSize: 24, marginLeft: -20, textAlign: 'center', color: chatColor }}>Team Discussions</Text>
                        <TouchableOpacity
                ...
                {!create && <ActionButton buttonColor={!liked ? "#0D3E56" : "#3BA1AE"} size={62} renderIcon={() => <Icon name="add" color="#fff" />} onPress={() => this.setState({ create: true })} />}
            </SafeAreaView >
        );
    }
}
